          ...
          <a className={styles.rectangleParent} onClick={onFrameLinkClick11}>
            ...
            <div className={styles.frameGroup}>
              <div className={styles.frameContainer}>
                ...
                <div className={styles.asABusinessOwnerInNepalWrapper}>
                  <div className={styles.asABusiness}>
                    Situated just steps from Naxal, within the charming Maya
                    Manor Boutique Hotel, Cinnamon Garden offers a beautifully
                    balanced blend of serenity and inventiveness—a creative
                    retreat in the heart of Kathmandu.
                  </div>
                </div>
              </div>
              <div className={styles.lineParent}>
          ...
          <a className={styles.rectangleParent} onClick={onFrameLinkClick12}>
            ...
            <div className={styles.frameGroup}>
              <div className={styles.frameContainer}>
                ...
                <div className={styles.asABusinessOwnerInNepalWrapper}>
                  <div className={styles.asABusiness}>
                    Coffee in Nepal has evolved. What was once a tea-first
                    country now has a booming café culture, with consumption
                    rising from the streets of Kathmandu to global shelves...
                  </div>
                </div>
              </div>
              <div className={styles.lineParent}>
